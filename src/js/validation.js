...
!function(a) {
    ...
    a.extend(a.fn, {
        ...
        rules: function(b, c) {
            ...
            if (null != j && (!j.form && j.isContentEditable && (j.form = this.closest("form")[0],
        ...
        a.extend(a.validator, {
            ...
            prototype: {
                init: function() {
                    function b(b) {
                        if (!this.form && this.isContentEditable && (this.form = a(this).closest("form")[0],
                ...
                elements: function() {
                    ...
                    return a(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                        ...
                        this.isContentEditable && (this.form = a(this).closest("form")[0],
                            this.name = d),
                ...
                elementValue: function(b) {
                    ...
                    return "radio" === f || "checkbox" === f ? this.findByName(b.name).filter(":checked").val() : "number" === f && "undefined" != typeof b.validity ? b.validity.badInput ? "NaN" : e.val() : (c = b.isContentEditable ? e.text() : e.val(),
